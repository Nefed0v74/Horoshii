...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/royal_forest.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Royal forest</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Royal forest - ${quantity} кг.  Итого: ${quantity * 221} руб.  Успешно добавлено в корзину!`;
