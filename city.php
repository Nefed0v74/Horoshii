...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/cookie/city_of_sweet_tooth.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Город Сладкоежек</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Город Сладкоежек - ${quantity} шт.  Итого: ${quantity * 343} руб.  Успешно добавлено в корзину!`;
