...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/zamanas.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Ананас европейский</h3>
            </p>
            <p>
                <h4>Урожай 2015 года<br>
                    ...
                    Условия хранения: Температура +13/+14 градуса, влажность 80% <br>
                    Срок годности не ограничен при соблюдении условия хранения
                </h4>
                <h1>125 р/кг</h1>
            </p>
        </div>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Ананас европейский - ${quantity} кг.  Итого: ${quantity * 125} руб.  Успешно добавлено в корзину!`;
