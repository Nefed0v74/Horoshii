...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/pear.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Груша "конференция"</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Груша "конференция" - ${quantity} кг.  Итого: ${quantity * 80} руб.  Успешно добавлено в корзину!`;
