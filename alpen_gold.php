...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/alpen_gold.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Alpen Gold</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Alpen Gold - ${quantity} кг.  Итого: ${quantity * 89} руб.  Успешно добавлено в корзину!`;
