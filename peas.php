...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/vegetables/peas.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Горох лущильный</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Горох лущильный - ${quantity} кг.  Итого: ${quantity * 110} руб.  Успешно добавлено в корзину!`;
