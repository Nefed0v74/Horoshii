...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/seasonings/mustard_seeds.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Семена горчицы</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Семена горчицы - ${quantity} кг.  Итого: ${quantity * 150} руб.  Успешно добавлено в корзину!`;
