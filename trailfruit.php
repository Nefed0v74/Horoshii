...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/trailfruit.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Грейпфрут красный</h3>
            </p>
            <p>
                <h4>Урожай 2015 года<br>
                    ...
                    Условия хранения: Температура 0/+4 градуса, влажность 80% <br>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Грейпфрут красный - ${quantity} кг.  Итого: ${quantity * 100} руб.  Успешно добавлено в корзину!`;
