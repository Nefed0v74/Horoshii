...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/seasonings/ground_cinnamon.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Молотая корица</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Молотая корица - ${quantity} кг.  Итого: ${quantity * 370} руб.  Успешно добавлено в корзину!`;
