...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/cookie/one.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Первым делом</h3>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Первым делом - ${quantity} шт.  Итого: ${quantity * 50} руб.  Успешно добавлено в корзину!`;
