...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/air.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Воздушный белый</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Воздушный белый - ${quantity} кг.  Итого: ${quantity * 99} руб.  Успешно добавлено в корзину!`;
