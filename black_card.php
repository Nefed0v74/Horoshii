...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/coffee/black_card.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Черная карта</h3>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Черная карта - ${quantity} шт.  Итого: ${quantity * 139} руб.  Успешно добавлено в корзину!`;
