...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/vegetables/cabbage.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Капуста кочанная</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Капуста кочанная - ${quantity} кг.  Итого: ${quantity * 80} руб.  Успешно добавлено в корзину!`;
