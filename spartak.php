...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/spartak.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Спартак</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Спартак - ${quantity} кг.  Итого: ${quantity * 119} руб.  Успешно добавлено в корзину!`;
