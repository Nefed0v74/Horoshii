...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/limon.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Лимон узбекистанский</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Лимон узбекистанский - ${quantity} кг.  Итого: ${quantity * 300} руб.  Успешно добавлено в корзину!`;
