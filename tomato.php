...
<body>
    ...
    <main>
        <div class="main conatainer_product">
            <div class="img">
                <img src="./img/vegetables/tomato.jfif" alt="">
            </div>
            <div class="text">
                <p>
                <h3>Томат европейский свежий</h3>
                </p>
                <p>
    ...
    confirmButton.addEventListener('click', () => {
        ...
        if (quantity > 0) {
            orderSummary.textContent =
                `Томат европейский свежий - ${quantity} кг.  Итого: ${quantity * 80} руб.  Успешно добавлено в корзину!`;
