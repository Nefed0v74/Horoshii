...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/garnet.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Гранат Азербайджанский</h3>
            </p>
            <p>
                <h4>Урожай 2015 года<br>
                    ...
                    Условия хранения: Температура +4/+6 градуса, влажность 80% <br>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Гранат Азербайджанский - ${quantity} кг.  Итого: ${quantity * 150} руб.  Успешно добавлено в корзину!`;
