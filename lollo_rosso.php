...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/green/Lollo_rosso.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Лолло-россо</h3>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Лолло-россо - ${quantity} кг.  Итого: ${quantity * 600} руб.  Успешно добавлено в корзину!`;
