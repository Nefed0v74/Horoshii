...
<?php
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/vegetables/onion.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Лук репчатый "Кармен"</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Лук репчатый "Кармен" - ${quantity} кг.  Итого: ${quantity * 65} руб.  Успешно добавлено в корзину!`;
