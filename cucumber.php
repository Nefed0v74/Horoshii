...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/vegetables/cucumber.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Огурец парниковый свежий</h3>
            </p>
            <p>
                <h4>Урожай 2015 года<br>
                    ...
                    Условия хранения: Температура +10/+12 градуса, влажность 80% <br>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Огурец парниковый свежий - ${quantity} кг.  Итого: ${quantity * 83} руб.  Успешно добавлено в корзину!`;
