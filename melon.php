...
<?php
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/vegetables/melon.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Дыня европейская адана</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Дыня европейская адана - ${quantity} кг.  Итого: ${quantity * 110} руб.  Успешно добавлено в корзину!`;
