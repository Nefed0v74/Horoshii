...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/vegetables/turnip.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Репа европейская</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Репа европейская - ${quantity} кг.  Итого: ${quantity * 70} руб.  Успешно добавлено в корзину!`;
