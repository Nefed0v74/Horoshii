...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/red_apple.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Яблоко красное "черный принц"</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Яблоко красное "черный принц" - ${quantity} кг.  Итого: ${quantity * 70} руб.  Успешно добавлено в корзину!`;
