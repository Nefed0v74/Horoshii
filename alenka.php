...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/alenka.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Аленка</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Аленка - ${quantity} кг.  Итого: ${quantity * 59} руб.  Успешно добавлено в корзину!`;
