...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/cookie/bryakonfi.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Бряконфи</h3>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Бряконфи - ${quantity} шт.  Итого: ${quantity * 257} руб.  Успешно добавлено в корзину!`;
