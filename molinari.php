...
<head>
    ...
    <title>Molinari Qualita Rosso</title>
...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/coffee/molinari_qualita_rosso.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Molinari Qualita Rosso</h3>
            </p>
            <p>
                <h4>Производство 2015 года<br>
                    Количество: 1 шт<br>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Molinari Qualita Rosso - ${quantity} шт.  Итого: ${quantity * 279} руб.  Успешно добавлено в корзину!`;
