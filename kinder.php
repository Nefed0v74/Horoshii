...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/kinder.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Kinder</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Kinder - ${quantity} кг.  Итого: ${quantity * 112} руб.  Успешно добавлено в корзину!`;
