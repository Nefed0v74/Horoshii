...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/seasonings/cardamon.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Кардамон</h3>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Кардамон - ${quantity} кг.  Итого: ${quantity * 2790} руб.  Успешно добавлено в корзину!`;
