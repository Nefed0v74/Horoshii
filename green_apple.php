...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/green_apple.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Яблоко зеленое "Гренни смит"</h3>
            </p>
            <p>
                <h4>Урожай 2015 года<br>
                    ...
                    Условия хранения: Температура +2/+4 градуса, влажность 80% <br>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Яблоко зеленое "Гренни смит" - ${quantity} кг.  Итого: ${quantity * 70} руб.  Успешно добавлено в корзину!`;
