...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/tangerine.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Мандарин "беби"</h3>
            ...
            <p>
                <h4>Урожай 2015 года<br>
                    ...
                    Условия хранения: Температура +5/+25 градуса, влажность 80% <br>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Мандарин "беби" - ${quantity} кг.  Итого: ${quantity * 120} руб.  Успешно добавлено в корзину!`;
