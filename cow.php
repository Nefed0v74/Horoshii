...
<body>
    ...
    ?>
    <main>
    <div class="main container_product">
        <div class="img">
            <img src="./img/cookie/cow.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Коровка</h3>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Коровка - ${quantity} шт.  Итого: ${quantity * 94} руб.  Успешно добавлено в корзину!`;
