...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/fruits/grape.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Виноград зеленый</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Виноград зеленый - ${quantity} кг.  Итого: ${quantity * 170} руб.  Успешно добавлено в корзину!`;
