...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/maitre.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад MAITRE</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад MAITRE - ${quantity} кг.  Итого: ${quantity * 238} руб.  Успешно добавлено в корзину!`;
