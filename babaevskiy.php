...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/babaevskiy.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Бабаевский</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Бабаевский - ${quantity} кг.  Итого: ${quantity * 79} руб.  Успешно добавлено в корзину!`;
