...
<body>
    ...
    <div class="main conatainer_product">
        <div class="img">
            <img src="./img/chocolate/ritter_sport.jfif" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Шоколад Ritter sport</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Шоколад Ritter sport - ${quantity} кг.  Итого: ${quantity * 179} руб.  Успешно добавлено в корзину!`;
