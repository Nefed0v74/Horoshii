...
<body>
    ...
    <div class="main conatainer">
        <div class="img">
            <img src="./img/vegetables/watermelon.webp" alt="">
        </div>
        <div class="text">
            <p>
                <h3>Арбуз астраханский</h3>
            </p>
            <p>
...
confirmButton.addEventListener('click', () => {
    ...
    if (quantity > 0) {
        orderSummary.textContent = `Арбуз астраханский - ${quantity} кг.  Итого: ${quantity * 130} руб.  Успешно добавлено в корзину!`;
